...
#define UUID_CHR_UV_INDEX 0X2A76
...
BLECharacteristic uv_index_characteristic = BLECharacteristic(UUID_CHR_UV_INDEX);
...
void setupESService(void){
  ...
  uv_index_characteristic.setFixedLen(0);
